  ...
  return (
    <MainLayout>
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-900">Настройки WhatsApp</h1>
          <p className="text-slate-600">
            Интеграция с WhatsApp через GREEN-API для отправки сообщений
          </p>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm opacity-90">
                  {status?.stateInstance || 'Статус неизвестен'}
                </p>
              </div>
            </div>
            <button
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
          <h4 className="font-medium text-blue-900 mb-2">📚 Как получить учётные данные:</h4>
          <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
            <li>Зарегистрируйтесь на <a href="https://green-api.com" target="_blank" rel="noopener" className="underline">green-api.com</a></li>
            <li>Создайте новый инстанс в личном кабинете</li>
            <li>Скопируйте <strong>idInstance</strong> и <strong>apiTokenInstance</strong></li>
            <li>Вставьте их в форму выше и сохраните</li>
            <li>Авторизуйте WhatsApp, отсканировав QR-код</li>
          </ol>
        </div>
      </div>
    </MainLayout>
